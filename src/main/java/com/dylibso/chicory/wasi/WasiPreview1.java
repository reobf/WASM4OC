...
public final class WasiPreview1 implements Closeable {
	public static class Logger{
		...
		public void tracef(String string, Object... arg) {
			// TODO Auto-generated method stub
			
		}

		public void errorf(String string, Object... arg) {
			// TODO Auto-generated method stub
    ...
    public int pathCreateDirectory(int dirFd,  String rawPath) {
    ...
    public int pathFilestatGet(
            Memory memory, int dirFd, int lookupFlags,  String rawPath, int buf) {
    ...
    public int pathReadlink(
            Memory memory, int dirFd,  String rawPath, int buf, int bufLen, int bufUsedPtr) {
        logger.tracef(
    ...
    public int pathRemoveDirectory(int dirFd,  String rawPath) {
    ...
    public int pathRename(
            int oldFd,  String oldRawPath, int newFd,  String newRawPath) {
        logger.tracef(
    ...
    public int pathSymlink( String oldRawPath, int dirFd,  String newRawPath) {
    ...
    public int pathUnlinkFile(int dirFd,  String rawPath) {
